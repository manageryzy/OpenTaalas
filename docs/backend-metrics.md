...
| Macro-bearing (GRT) | 2–3 | TBD (macro-dominated) | 4–13.4 mm² |
...
|-------------|--------|-------|
| All 18 modules have PnR results | 15/19 have results | 3 blocked (vector_unit, kv_cache, lm_head), 1 pending (embed_rom) |
...
**Practical outcome:** 12 logic-only modules complete to GDS. 2–3 macro-bearing modules reach GRT with ODB artifacts suitable for incremental improvement. The 880-pin NOR ROM congestion is a fundamental routing density problem — mitigating it requires either pin multiplexing (serialized output) or a hierarchical routing strategy.
