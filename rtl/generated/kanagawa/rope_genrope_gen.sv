...
module rope_genDebugView_read_cos_rowExit
(
    input wire clk,
...
module rope_genDebugView_read_sin_rowEntry
(
    input wire clk,
    input wire[11:0]  _position,
    input wire valid,
...
module rope_genDebugView_read_sin_rowExit
(
    input wire clk,
    input wire[1023:0]  _ReturnValue,
    input wire valid,
...
module rope_genDebugView_write_cos_rowEntry
(
    input wire clk,
    input wire[11:0]  _position,
...
module rope_genDebugView_write_sin_rowEntry
(
    input wire clk,
    input wire[11:0]  _position,
    input wire[1023:0]  _value,
...
module rope_gen_write_sin_row_BasicBlock_0(	// rope_gen.k:48:9
  ...
  output wire [1023:0] memory_write_data_out_9_0,
  output wire [11:0]   memory_write_addr_out_9_0,
  ...
  wire           _GEN = ~rst & _fifo_almostfull_ffc_0_data_out;	// rope_gen.k:48:9
  wire           _GEN_0 = _GEN & input_valid_0;	// rope_gen.k:48:9
  always_comb begin	// rope_gen.k:48:9
    input_rdy_0_0 = _GEN;	// rope_gen.k:48:9
    control_state_out_0 =
      {2'h0,
  ...
  always @(posedge clk) begin	// rope_gen.k:48:9
    ...
    else begin	// rope_gen.k:48:9
      p0_stage1_enable <= _GEN_0;	// rope_gen.k:48:9
      p0_stage2_enable <= p0_stage1_enable;	// rope_gen.k:48:9
    end
  end // always @(posedge)
  always_comb	// rope_gen.k:48:9
    fifo_wren_0_0 = p0_stage2_enable;	// rope_gen.k:48:9, :49:9
  KanagawaFlipFlopChainNoEnable #(
    .WIDTH(1),
    .DEPTH(1)
  ) fifo_almostfull_ffc_0 (
    .clk      (clk),
    .data_in  (~fifo_almost_full_in_raw_0),	// rope_gen.k:48:9
  ...
  rope_genDebugView_write_sin_rowEntry rope_genDebugView_write_sin_rowEntry_instance (	// rope_gen.k:49:9
    ...
    .valid     (p0_stage1_enable),	// rope_gen.k:48:9
    .valid_out (/* unused */)
  );	// rope_gen.k:49:9
...
module rope_gen_read_sin_row_BasicBlock_0(	// rope_gen.k:34:9
  ...
  input  wire          rst,
  output wire          done_out,
  input  wire [1023:0] memory_read_data_in_9_0,
  output wire [11:0]   memory_read_addr_out_9_0,
...
module rope_gen_read_cos_row_BasicBlock_0(	// rope_gen.k:26:9
  ...
  input  wire          rst,
  output wire          done_out,
  input  wire [1023:0] memory_read_data_in_8_0,
  output wire [11:0]   memory_read_addr_out_8_0,
  output wire          memory_rden_out_8_0,
  output wire [1023:0] fifo_data_out_0,
  output wire          fifo_wren_0,
  input  wire          fifo_almost_full_in_raw_0,
  input  wire          fifo_overflow_in_0,
  input  wire [11:0]   data_in_4,
  input  wire          input_fifo_underflow_0,
  output wire          input_rdy_0,
  input  wire          input_valid_0,
  output wire [7:0]    control_state_out
...
module rope_gen__cos_table__mem_container(	// rope_gen.k:19:5
  ...
  wire [1:0][1023:0] ___cos_table_0_data_out;	// rope_gen.k:19:5
  KanagawaSyncRam #(
    .DATA_WIDTH(1024),
    .ADDR_WIDTH(12),
    .DEPTH(4096),
    ...
    .DEVICE_FAMILY("mock")
  ) __cos_table_0 (	// rope_gen.k:19:5
    .clk            (clk),	// rope_gen.k:19:5
    .rst            (rst),
    .addr_in        ({{read_addr_in_0}, {write_addr_in_0}}),	// rope_gen.k:19:5
    .ecc_status_out (/* unused */),
    .wren_in        ({{1'h0}, {wren_in_0}}),	// rope_gen.k:19:5
    .data_in        ({{1024'h0}, {write_data_in_0}}),	// rope_gen.k:19:5
    .rden_in        ({{rden_in_0}, {1'h0}}),	// rope_gen.k:19:5
    .data_out       (___cos_table_0_data_out)
  );	// rope_gen.k:19:5
  assign read_data_out_0 = ___cos_table_0_data_out[1'h1];	// rope_gen.k:19:5
  assign init_completed = 1'h1;	// rope_gen.k:19:5
endmodule

module rope_gen__sin_table__mem_container(	// rope_gen.k:20:5
  input  wire          clk,
  input  wire          rst,
  input  wire          rden_in_0,
  input  wire [11:0]   read_addr_in_0,
  ...
  wire [1:0][1023:0] ___sin_table_0_data_out;	// rope_gen.k:20:5
  KanagawaSyncRam #(
    .DATA_WIDTH(1024),
    .ADDR_WIDTH(12),
    .DEPTH(4096),
    ...
    .INITIAL_DATA_FILE("UNUSED"),
    .DEVICE_FAMILY("mock")
  ) __sin_table_0 (	// rope_gen.k:20:5
    .clk            (clk),	// rope_gen.k:20:5
    .rst            (rst),
    .addr_in        ({{read_addr_in_0}, {write_addr_in_0}}),	// rope_gen.k:20:5
    .ecc_status_out (/* unused */),
    .wren_in        ({{1'h0}, {wren_in_0}}),	// rope_gen.k:20:5
    .data_in        ({{1024'h0}, {write_data_in_0}}),	// rope_gen.k:20:5
    .rden_in        ({{rden_in_0}, {1'h0}}),	// rope_gen.k:20:5
    .data_out       (___sin_table_0_data_out)
  );	// rope_gen.k:20:5
  assign read_data_out_0 = ___sin_table_0_data_out[1'h1];	// rope_gen.k:20:5
  assign init_completed = 1'h1;	// rope_gen.k:20:5
endmodule
...
module rope_gen(
  ...
  wire [1023:0] __sin_table_read_data_out_0;	// rope_gen.k:20:5
  wire          __sin_table_init_completed;	// rope_gen.k:20:5
  wire [1023:0] __cos_table_read_data_out_0;	// rope_gen.k:19:5
  wire          __cos_table_init_completed;	// rope_gen.k:19:5
  ...
  wire          _GEN =
    has_startup_completed_raw & __cos_table_init_completed & __sin_table_init_completed;	// rope_gen.k:19:5, :20:5
  ...
  assign read_cos_row_rdy_out_net = passthrough_data_4.rdy_ext;
  assign passthrough_data_4.valid = read_cos_row_rdy_out & read_cos_row_valid_in;
  assign passthrough_data_4.data = { read_cos_row_position_in };
  ...
  assign read_sin_row_rdy_out_net = passthrough_data_5.rdy_ext;
  assign passthrough_data_5.valid = read_sin_row_rdy_out & read_sin_row_valid_in;
  assign passthrough_data_5.data = { read_sin_row_position_in };
  ...
  assign write_cos_row_rdy_out_net = passthrough_data_6.rdy_ext;
  assign passthrough_data_6.valid = write_cos_row_rdy_out & write_cos_row_valid_in;
  assign passthrough_data_6.data = { write_cos_row_value_in, write_cos_row_position_in };
  assign fifo_data_2.rden = write_cos_row_rden_in;
  assign write_cos_row_empty_out_net = fifo_data_2.empty;
  assign write_sin_row_rdy_out_net = passthrough_data_7.rdy_ext;
  assign passthrough_data_7.valid = write_sin_row_rdy_out & write_sin_row_valid_in;
  assign passthrough_data_7.data = { write_sin_row_value_in, write_sin_row_position_in };
