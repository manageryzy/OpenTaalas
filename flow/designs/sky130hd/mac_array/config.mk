...
export VERILOG_FILES   = $(_project)/rtl/generated/kanagawa/mac_array_mac_array.sv \
                         $(_project)/rtl/generated/kanagawa/mac_array_mac_array_types.sv \
                         $(KANAGAWA_RUNTIME_SV) \
                         $(MACRO_BB)
...
export DIE_AREA  = 0 0 1800 2400
export CORE_AREA = 10 10 1790 2390
