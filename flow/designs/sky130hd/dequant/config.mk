export DESIGN_NICKNAME = dequant
export DESIGN_NAME     = dequant_unit
...
export VERILOG_FILES   = $(_project)/rtl/generated/kanagawa/dequantdequant_unit.sv \
                         $(_project)/rtl/generated/kanagawa/dequantdequant_unit_types.sv \
                         $(KANAGAWA_RUNTIME_SV)
