export DESIGN_NICKNAME = kv_cache
export DESIGN_NAME     = kv_cache
...
export VERILOG_FILES   = $(_project)/rtl/generated/kanagawa/kv_cachekv_cache.sv \
                         $(_project)/rtl/generated/kanagawa/kv_cachekv_cache_types.sv \
                         $(KANAGAWA_RUNTIME_SV)
